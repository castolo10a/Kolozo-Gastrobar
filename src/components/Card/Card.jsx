...
//       <div
//         className={`relative bg-cover bg-center h-60 md:h-96 ${image}`}
//       >
//         <div className="absolute inset-0 bg-opacity-40 bg-black flex flex-col justify-between p-4 md:p-6">
//           <h1 className="text-lg md:text-xl text-white font-semibold mb-2 md:mb-4">
//             {name}
//           </h1>
...
export default function Card({ path, textButton, image, name }) {
  return (
    <div className="w-full md:w-1/3 p-4 md:inline-block">
      <div className={`relative bg-cover bg-center h-60 md:h-96 ${image}`}>
